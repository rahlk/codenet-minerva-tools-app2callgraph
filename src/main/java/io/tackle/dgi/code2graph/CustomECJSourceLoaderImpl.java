...
import io.tackle.dgi.code2graph.ir.Code2GraphIRGen;

// TODO: Why does this class lines fix issue #1
public class CustomECJSourceLoaderImpl extends ECJSourceLoaderImpl {
    private final String[] stdlibs;
    Map<String, ModuleEntry> sourceMap = HashMapFactory.make();
    int countdown;
    String[] jdtDirs;

    public CustomECJSourceLoaderImpl(ClassLoaderReference loaderRef, IClassLoader parent, IClassHierarchy cha,
            String[] stdlibs) {
    ...
    protected SourceModuleTranslator getTranslator() {
        ...
        return new ECJSourceModuleTranslator(cha.getScope(), this, false) {
            ...
            public void loadAllSources(Set<ModuleEntry> sourceFiles) {
                ...
                Code2GraphIRGen irgen = new Code2GraphIRGen(
                        CustomECJSourceLoaderImpl.this, c -> loadedClasses.put(c.getName(), c));
